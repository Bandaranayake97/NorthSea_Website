  ...
  return (
    <div>
      <div className='aboutus-page'>
        ...
        <HeroSection>
          <h1 className='about-text'><span className='about-text-bold'>About Us</span></h1>
        </HeroSection>
      ...
      <div className="member">
        ...
        <div className="memberCards">
          <MemberCard
            props={{
              image: member1, member_name: "HON. DOUGLAS DEVANANDA", member_post: "Cabinet Minister", member_ministry: "Ministry of Transport", member_tel: "02-123-4567",
              member_fax: "02-123-4567", member_mail: "ff"
            }} />
          <MemberCard
            props={{
              image: member1, member_name: "Mr. A", member_post: "CEO", member_ministry: "Ministry of Transport", member_tel: "02-123-4567",
              member_fax: "02-123-4567", member_mail: "ff"
            }} />
          <MemberCard
            props={{
      ...
      <div className='directors'>
        ...
        <div className='director-items'>
          ...
          <DirectorCard
            props={{
              image: director1, member_name: "Mr. A", member_post: "CEO", member_ministry: "Ministry of Transport", member_tel: "02-123-4567",
              member_fax: "02-123-4567", member_mail: "ff"
            }} />
          <Line />
          ...
          <div className='director-info'>
            <DirectorDescriptionCard
              props={{
                member_name: "Mr. A", member_post: "CEO", member_ministry: "Ministry of Transport", member_tel: "02-123-4567",
                member_fax: "02-123-4567", member_mail: "ff"
              }} />
            <DirectorDescriptionCard
              props={{
                member_name: "Mr. A", member_post: "CEO", member_ministry: "Ministry of Tr dfe efesansport", member_tel: "02-123-4567",
                member_fax: "02-123-4567", member_mail: "ff"
              }} />
